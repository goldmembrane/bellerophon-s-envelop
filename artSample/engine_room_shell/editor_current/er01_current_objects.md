...
private static readonly TransformOverride[] UserEditedTransformOverrides =
{
    ...
    new TransformOverride("Entrances - individually editable/ER-01 3시 Control corridor side wall 2", new Vector3(5.415f, 0.928f, 0.856f), Quaternion.Euler(0f, 90f, 0f), new Vector3(0.26f, 1.97f, 2.55f)),
