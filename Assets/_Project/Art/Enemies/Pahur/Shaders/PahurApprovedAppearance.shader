Shader "Bellerophon/Pahur/ApprovedAppearance"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                // The approved Blender sample used a bright neutral world plus
                // warm key, cool fill, and cool rim area lights. Keep that
                // authored material response as a floor without replacing any
                // brighter lighting already supplied by the gameplay scene.
