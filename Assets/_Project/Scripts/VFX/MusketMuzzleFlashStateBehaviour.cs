...
{
    public sealed class MusketMuzzleFlashStateBehaviour : StateMachineBehaviour
    {
        [SerializeField, Range(0f, 0.95f)]
        private float normalizedTriggerTime = 0.08f;

        private MusketMuzzleFlashVfx effect;
        ...
        public override void OnStateEnter(
            ...
            int layerIndex)
        {
            effect = animator.GetComponentInChildren<MusketMuzzleFlashVfx>(true);
