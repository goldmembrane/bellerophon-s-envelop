...
{
    public sealed class SpeakerIdleLocomotionCycleBehaviour : StateMachineBehaviour
    {
            ...
            out float phaseElapsed)
        {
            ...
            phase = 0;
            phaseElapsed = 0f;
            if (animator == null || !StartTimes.TryGetValue(animator.GetInstanceID(), out float start))
                return false;
