...
$logPath = Join-Path $logDir "CkDmg09Sample.log"
$stdoutPath = Join-Path $logDir "CkDmg09Sample.stdout.log"
$stderrPath = Join-Path $logDir "CkDmg09Sample.stderr.log"
$scriptPath = Join-Path $projectRoot "scripts\GenerateCkDmg09Sample.py"
$sampleRoot = Join-Path $projectRoot "artSample\ck_dmg09"
...
$requiredFiles = @(
  ...
  "blender\ck_dmg09.blend",
  "exports\ck_dmg09.fbx",
  "exports\ck_dmg09.glb",
  "renders\01_front.png",
  "renders\02_player.png",
  "renders\03_side.png",
  "renders\04_top.png",
  "renders\05_detail.png",
  "renders\06_condition_swap.png"
)

foreach ($relative in $requiredFiles) {
  $path = Join-Path $sampleRoot $relative
  if (-not (Test-Path -LiteralPath $path)) {
    Write-Error "Missing generated CK-09 sample file: $path"
    exit 1
  }
}
