...
Current status: stage 1 direction is approved, stage 2 ship interior P0 samples are approved for runtime work, and actual runtime integration has not started yet.
...
| Priority | Asset | Notes | Approval State |
| --- | --- | --- | --- |
| P0 | Contract cargo container | Core transport target visual. | Sample Required |
| P0 | Cargo strap/bracket set | Cargo hold identity. | Sample Required |
| P0 | Cockpit status screens | Transport progress/readiness surface. | Sample Required |
| P0 | Manual turret grip and mount | Armory interaction identity. | Sample Required |
| P1 | Control room CCTV terminal | CCTV target display. | Sample Required |
| P1 | Engine room power terminal | Overclock/damage state display. | Sample Required |
| P1 | Supply room storage cabinet | Inventory storage surface. | Sample Required |
| P1 | Cargo hold status panel | Cargo state readout. | Sample Required |
| P1 | Repair panel kit | Damaged room interaction/readability. | Planned |
| P2 | Warning label/stencil pack | Repeated detail. | Planned |
| P2 | Loose industrial clutter | Must not block navigation. | Planned |
| P2 | Escape/discarded pod visual | Game-over sequence. | Sample Required |
...
| P0 | Stick first-person model | Default weapon. | Sample Required |
| P0 | Musket first-person model | Early shop weapon. | Sample Required |
| P1 | Basic protective suit model/readout | Player identity and future multiplayer readability. | Sample Required |
| P1 | Presence detector | Special contract equipment. | Planned |
| P1 | Light blade | Special contract equipment. | Planned |
| P1 | Electric mine | Special contract equipment. | Planned |
| P1 | Corridor purifier | Special contract equipment. | Planned |
